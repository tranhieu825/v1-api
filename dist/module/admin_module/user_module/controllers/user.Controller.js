...
const user_model_2 = require("../../../../common/model/user.model");
            ...
            try {
                ...
                if (user.length === 1) {
                    ...
                    if (check) {
                        ...
                        if (result.role === user_model_2.RoleCode.Admin) {
                            const messageSuccess = "Đây là trang admin";
                            return response_service_1.success(res, result, messageSuccess, 201);
                        }
                        return response_service_1.error(res, "Bạn không phải admin", 200);
                    }
